...
@InputType()
class DonationCreateNestedManyWithoutCampaignsInput {
...
export { DonationCreateNestedManyWithoutCampaignsInput as DonationCreateNestedManyWithoutCampaignsInput };
